...
y1 = sigmoid(x * w1)
y1.register_hook(lambda grad: print(f"Grad y1 = {grad}"))

y2 = sigmoid(y1 * w2)
y2.register_hook(lambda grad: print(f"Grad y2 = {grad}"))

y3 = sigmoid(y2 * w3)
y3.register_hook(lambda grad: print(f"Grad y3 = {grad}"))

y4 = sigmoid(y3 * w4)
y4.register_hook(lambda grad: print(f"Grad y4 = {grad}"))

y5 = sigmoid(y4 * w5)
y5.register_hook(lambda grad: print(f"Grad y5 = {grad}"))
